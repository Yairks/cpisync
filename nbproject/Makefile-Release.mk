...
${TESTDIR}/tests/CommunicantTest.o: tests/CommunicantTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/opt/local/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CommunicantTest.o tests/CommunicantTest.cpp


${TESTDIR}/tests/CommunicantTestRunner.o: tests/CommunicantTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/opt/local/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CommunicantTestRunner.o tests/CommunicantTestRunner.cpp
...
${TESTDIR}/tests/LoggerTest.o: tests/LoggerTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/opt/local/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/LoggerTest.o tests/LoggerTest.cpp


${TESTDIR}/tests/LoggerTestRunner.o: tests/LoggerTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/opt/local/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/LoggerTestRunner.o tests/LoggerTestRunner.cpp


${TESTDIR}/tests/CommStringTest.o: tests/CommStringTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/opt/local/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CommStringTest.o tests/CommStringTest.cpp


${TESTDIR}/tests/CommStringTestRunner.o: tests/CommStringTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/opt/local/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CommStringTestRunner.o tests/CommStringTestRunner.cpp
